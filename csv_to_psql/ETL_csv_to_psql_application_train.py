...
# Build table
cur.execute("""
DROP TABLE IF EXISTS kaggle_hcdr.application_train;
CREATE TABLE kaggle_hcdr.application_train
(
    SK_ID_CURR numeric,
    TARGET numeric,
